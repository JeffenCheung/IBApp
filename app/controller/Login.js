Ext.define('IBApp.controller.Login', {
	...
	signInSuccess: function (userRoles) {
	    ...
	    //为当前userId为别名
		if(window.plugins && window.plugins.jPushPlugin) window.plugins.jPushPlugin.setAlias(Ext.getStore("UserInfo").getAt(0).get('userId'));
	...
	onSignOffCommand: function () {
		...
		if(window.plugins && window.plugins.jPushPlugin) window.plugins.jPushPlugin.setAlias('');
